 ...
 */
goceanApp.controller('QiusongPrepayPayCtrl', function ($scope, $rootScope, $state, $timeout, $stateParams) {
    console.log("about QiusongPrepayPayCtrl");
    var _state = "qiusongPay/" + $stateParams.qiusongId;
