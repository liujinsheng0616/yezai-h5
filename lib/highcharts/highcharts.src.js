...
// encapsulated variables
    ...
    Pointer.prototype = {
        ...
        normalize: function (e, chartPosition) {
            ...
            // iOS (#2757)
			//取消e.touches.item报错问题 by ljf
            ePos = e.touches ?  (e.touches.length ? (e.touches.item?e.touches.item(0):e.touches[0]) : e.changedTouches[0]) : e;
        ...
        runPointActions: function (e) {
			...
			//修正触摸时crosshair标线位置不对的bug by ljf
            //shared ? kdpoints : [pick(hoverPoint, kdpoint[1])], => shared ? kdpoints : [kdpoint[1]]
            each(shared ? kdpoints : [kdpoint[1]], function (point) { // #5269
        ...
        onDocumentMouseMove: function (e) {
            ...
            if (chartPosition && !this.inClass(e.target, 'highcharts-tracker') &&
                ...
                //注释掉来解决移动端，点击数据上方空白区域也能显示tooltip by ljf
                //this.reset();
            }
        },
        ...
        setItemEvents: function (item, legendItem, useHTML, itemStyle, itemHiddenStyle) {
            ...
            .on('click', function (event) {
                ...
                if (item.firePointEvent) { // point
                    ...
                    //解决ios点击图例时的问题 by ljf from old code
